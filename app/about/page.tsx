export default function Page() {
  return (
    <div className="flex items-start flex-col w-[75%]">
      ...
      <p className="  ">
        On December 5 2025, LTA informed the public that the transport operators
        SMRT and SBS Transit will "will prioritise on-site communications for
        minor MRT delays" instead of broadcasting on social media. We feel it is
        still important to have a knowledge of which stations are affected by
        such delays to better plan our routes to our destinations.
      </p>
      <p className="  ">
        Hence we made this to act as a crowdsourced information of which
        stations are facing delays in services and display it easily for users
        to see!
      </p>
