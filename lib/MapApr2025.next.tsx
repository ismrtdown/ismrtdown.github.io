...
const _MapApr2025: React.ForwardRefRenderFunction<SVGSVGElement> = (
  _props,
  ref,
) => {
    ...
    >
      ...
      <defs>
        ...
        <clipPath id="clip128_13_2">
          <rect x="716" y="853" width="53.5" height="24" rx="10" fill="white" />
        </clipPath>
...
export const MapApr2025 = forwardRef(_MapApr2025);

MapApr2025.displayName = 'MapApr2025';
