      ...
      <div className="relative overflow-hidden">
        <div className="overflow-auto">
          ...
          <div
            ...
            data-orientation="horizontal"
            role="tabpanel"
            aria-labelledby="radix-:rpn:-trigger-2025-04"
            id="radix-:rpn:-content-2025-04"
            tabIndex={0}
            style={{}}
          >
            <svg
